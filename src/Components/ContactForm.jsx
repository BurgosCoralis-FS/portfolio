...
>
      <div>
        <h2
          style={{ fontFamily: "Exo Bold, sans-serif" }}
      ...
      <div className="w-full flex justify-center">
        ...
        >
          ...
          <label htmlFor="firstname" style={{ fontWeight: 'bold', fontSize: '18px', color: 'white' }}>First Name</label>
            <input
          ...
          <div className="w-full flex flex-col">
          <label htmlFor="lastname" style={{ fontWeight: 'bold', fontSize: '18px', color: 'white' }}>Last Name</label>
            <input
              className="p-[0.5em] rounded-xl text-grayscale-950 bg-primary-200"
          ...
          <div className="w-full flex flex-col">
          <label htmlFor="email" style={{ fontWeight: 'bold', fontSize: '18px', color: 'white' }}>E-mail</label>
            <input
              className="p-[0.5em] rounded-xl text-grayscale-950 bg-primary-200"
          ...
          <div className="w-full flex flex-col">
          <label htmlFor="message" style={{ fontWeight: 'bold', fontSize: '18px', color: 'white' }}>Message</label>
            <textarea
